...
SET ASPOSE_ROOT=C:\project\Release\Release_20.10\Aspose.Email_for_C++_20.10
SET ASPOSE_EMAIL_CPP_ROOT=C:\project\Release\Release_20.10\Aspose.Email_for_C++_20.10
