...
void SetWeeklyEndAfterDateRecurrence()
{
    ...
    auto rec = [&]{ auto tmp_0 = System::MakeObject<MapiCalendarWeeklyRecurrencePattern>(); tmp_0->set_EndType(Aspose::Email::Mapi::MapiCalendarRecurrenceEndType::EndAfterDate); tmp_0->set_PatternType(Aspose::Email::Mapi::MapiCalendarRecurrencePatternType::Week); tmp_0->set_Period(1); tmp_0->set_WeekStartDay(System::DayOfWeek::Sunday); tmp_0->set_DayOfWeek(Aspose::Email::Mapi::MapiCalendarDayOfWeek::Friday); tmp_0->set_EndDate(endByDate); tmp_0->set_OccurrenceCount(GetOccurrenceCount(StartDate, endByDate, u"FREQ=WEEKLY;BYDAY=FR;INTERVAL=1")); return tmp_0; }();
    ...
    task->Save(dataDir + u"SetWeeklyEndAfterDateEveryDayRecurrence_out.msg", Aspose::Email::Mapi::TaskSaveFormat::Msg);
    
    // ExStart:SetWeeklyEndAfterDateMultipleDaysRecurrence
    auto record = [&]{ auto tmp_1 = System::MakeObject<MapiCalendarWeeklyRecurrencePattern>(); tmp_1->set_EndType(Aspose::Email::Mapi::MapiCalendarRecurrenceEndType::EndAfterDate); tmp_1->set_PatternType(Aspose::Email::Mapi::MapiCalendarRecurrencePatternType::Week); tmp_1->set_Period(2); tmp_1->set_WeekStartDay(System::DayOfWeek::Sunday); tmp_1->set_EndDate(endByDate); tmp_1->set_DayOfWeek(Aspose::Email::Mapi::MapiCalendarDayOfWeek::Friday | Aspose::Email::Mapi::MapiCalendarDayOfWeek::Monday); tmp_1->set_OccurrenceCount(GetOccurrenceCount(StartDate, endByDate, u"FREQ=WEEKLY;BYDAY=FR,MO;INTERVAL=2")); return tmp_1; }();
    // ExEnd:SetWeeklyEndAfterDateMultipleDaysRecurrence
    
    task->set_Recurrence(record);
    task->Save(dataDir + u"SetWeeklyEndAfterDateMultipleDaysRecurrence_out.msg", Aspose::Email::Mapi::TaskSaveFormat::Msg);
