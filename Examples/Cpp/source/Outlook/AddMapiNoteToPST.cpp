...
void AddMapiNoteToPST()
{
    ...
    // Create three Notes  
    System::SharedPtr<MapiNote> note1 = System::DynamicCast<Aspose::Email::Mapi::MapiNote>(mess->ToMapiMessageItem());
    note1->set_Subject(u"Yellow color note");
    note1->set_Body(u"This is a yellow color note");
    
    System::SharedPtr<MapiNote> note2 = System::DynamicCast<Aspose::Email::Mapi::MapiNote>(mess->ToMapiMessageItem());
    ...
    System::SharedPtr<MapiNote> note3 = System::DynamicCast<Aspose::Email::Mapi::MapiNote>(mess->ToMapiMessageItem());
