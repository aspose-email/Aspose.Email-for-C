...
void EndAfterNoccurrenceSelectMultipleDaysInweek()
{
    ...
    task->Save(dataDir + u"EndAfterNoccurrenceSelectMultipleDaysInweek_out.msg", Aspose::Email::Mapi::TaskSaveFormat::Msg);
}
