...
void SetMonthlyEndAfterDateRecurrence()
{
    ...
    auto recurrence = [&]{ auto tmp_0 = System::MakeObject<MapiCalendarMonthlyRecurrencePattern>(); tmp_0->set_Day(15); tmp_0->set_Period(1); tmp_0->set_PatternType(Aspose::Email::Mapi::MapiCalendarRecurrencePatternType::Month); tmp_0->set_EndType(Aspose::Email::Mapi::MapiCalendarRecurrenceEndType::EndAfterDate); tmp_0->set_OccurrenceCount(GetOccurrenceCount(StartDate, endByDate, u"FREQ=MONTHLY;BYMONTHDAY=15;INTERVAL=1")); tmp_0->set_WeekStartDay(System::DayOfWeek::Monday); tmp_0->set_EndDate(endByDate); return tmp_0; }();
