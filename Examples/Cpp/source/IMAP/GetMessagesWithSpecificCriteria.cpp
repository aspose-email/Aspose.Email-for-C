...
void GetMessagesWithSpecificCriteria()
{
    ...
    try
    {
        ...
        System::SharedPtr<ImapQueryBuilder> queryBuilder = System::MakeObject<ImapQueryBuilder>();
        
        queryBuilder->HasFlags(ImapMessageFlags::Keyword(u"custom1"));
        
        queryBuilder->HasNoFlags(ImapMessageFlags::Keyword(u"custom2"));
