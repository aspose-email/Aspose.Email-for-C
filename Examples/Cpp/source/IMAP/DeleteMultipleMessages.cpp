        ...
        try
        {
            
            {
                ...
                try
                {
                    ...
                    System::SharedPtr<System::Collections::Generic::List<System::String>> uidList = System::MakeObject<System::Collections::Generic::List<System::String>>();
                    const int32_t messageNumber = 5;
                    for (int32_t i = 0; i < messageNumber; i++)
                    {
                        System::SharedPtr<MailMessage> message = System::MakeObject<MailMessage>(u"from@Aspose.com", u"to@Aspose.com", System::String(u"EMAILNET-35226 - ") + System::Guid::NewGuid(), u"EMAILNET-35226 Add ability in ImapClient to delete messages and change flags for set of messages");
